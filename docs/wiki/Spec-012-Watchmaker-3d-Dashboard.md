...
<!-- Auto-generated from specs/012-watchmaker-3d-dashboard/spec.md -->
<!-- Generated: 2026-02-09T09:07:02.889713+00:00 -->
...
- [Design Philosophy](#design-philosophy)
  - [The Watchmaker Principles](#the-watchmaker-principles)
  - [1. PRECISION - The Horologist's Eye](#1-precision---the-horologists-eye)
  - [2. MECHANISM - The Visible Engine](#2-mechanism---the-visible-engine)
  - [3. DEPTH - The Layered Watch Movement](#3-depth---the-layered-watch-movement)
  - [4. FUNCTION - Purpose-Driven Design](#4-function---purpose-driven-design)
  - [5. CRAFT - Beauty in Precision](#5-craft---beauty-in-precision)
- [3D Interactive Space Architecture](#3d-interactive-space-architecture)
  - [Dashboard Structure](#dashboard-structure)
  - [Schematic-Based Organization](#schematic-based-organization)
  - [Information Architecture Tiers](#information-architecture-tiers)
- [Visual Components](#visual-components)
  - [Gear Component (Watchmaker Signature)](#gear-component-watchmaker-signature)
  - [Pulse Line (Data Flow)](#pulse-line-data-flow)
  - [Status Jewel (Health Indicator)](#status-jewel-health-indicator)
  - [3D Card Component](#3d-card-component)
- [Dashboard Sections](#dashboard-sections)
  - [1. Command Center (Home)](#1-command-center-home)
  - [2. Service Constellation](#2-service-constellation)
  - [3. GPU Workbench](#3-gpu-workbench)
- [CSS Variables (Watchmaker Extension)](#css-variables-watchmaker-extension)
- [Implementation Requirements](#implementation-requirements)
  - [Dashboard Updates](#dashboard-updates)
  - [Required Files](#required-files)
- [Theme Lock Declaration](#theme-lock-declaration)
- [Success Metrics](#success-metrics)
- [GitHub Pages Requirements (LOCKED)](#github-pages-requirements-locked)
  - [Page Ethos](#page-ethos)
  - [Content Security Rules](#content-security-rules)
  - [Project Health Metrics (Objective Data)](#project-health-metrics-objective-data)
  - [Page Structure Requirements](#page-structure-requirements)
  - [Visual Design Lock](#visual-design-lock)
  - [Accessibility Requirements](#accessibility-requirements)
  - [Performance Audit (Static)](#performance-audit-static)
  - [Page Ethos Declaration](#page-ethos-declaration)
  - [Documentation Update (Phase 7)](#documentation-update-phase-7)
...
---
*Source: [specs/012-watchmaker-3d-dashboard/spec.md](../../../specs/012-watchmaker-3d-dashboard/spec.md)*
