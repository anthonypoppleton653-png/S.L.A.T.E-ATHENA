...
<!-- Auto-generated from specs/021-autonomous-task-loop/spec.md -->
<!-- Generated: 2026-02-09T09:07:03.163689+00:00 -->
...
- [Core Components](#core-components)
  - [1. Unified Autonomous Loop (`slate_unified_autonomous.py`)](#1-unified-autonomous-loop-slate_unified_autonomouspy)
  - [2. Integrated Autonomous Loop (`integrated_autonomous_loop.py`)](#2-integrated-autonomous-loop-integrated_autonomous_looppy)
  - [3. Copilot Slate Runner (`copilot_slate_runner.py`)](#3-copilot-slate-runner-copilot_slate_runnerpy)
- [5-Source Task Discovery](#5-source-task-discovery)
  - [Discovery Flow](#discovery-flow)
- [ML Classification System](#ml-classification-system)
  - [Classification Result](#classification-result)
- [Agent Routing](#agent-routing)
  - [Code Task Execution Flow](#code-task-execution-flow)
  - [Inference Fallback Chain](#inference-fallback-chain)
- [Self-Healing Capabilities](#self-healing-capabilities)
  - [Health Check Flow](#health-check-flow)
  - [Self-Heal Flow](#self-heal-flow)
- [Error Recovery](#error-recovery)
  - [Task-Level Recovery](#task-level-recovery)
  - [Code Change Safety](#code-change-safety)
  - [Stale Task Detection](#stale-task-detection)
- [Workflow Integration](#workflow-integration)
- [State Management](#state-management)
  - [Unified Autonomous State (`.slate_autonomous_state.json`)](#unified-autonomous-state-slate_autonomous_statejson)
  - [Integrated State (`.slate_integrated_state.json`)](#integrated-state-slate_integrated_statejson)
- [CLI Reference](#cli-reference)
  - [slate_unified_autonomous.py](#slate_unified_autonomouspy)
  - [integrated_autonomous_loop.py](#integrated_autonomous_looppy)
  - [copilot_slate_runner.py](#copilot_slate_runnerpy)
...
---
*Source: [specs/021-autonomous-task-loop/spec.md](../../../specs/021-autonomous-task-loop/spec.md)*
