...
<!-- Auto-generated from specs/017-claude-agent-sdk/spec.md -->
<!-- Generated: 2026-02-09T09:07:02.990926+00:00 -->
...
- [Core Components](#core-components)
  - [1. Tool Registration System](#1-tool-registration-system)
  - [2. Hook System (ActionGuard Integration)](#2-hook-system-actionguard-integration)
  - [3. Subagent System](#3-subagent-system)
  - [4. Agent Options Builder](#4-agent-options-builder)
- [Session Management](#session-management)
  - [Session Lifecycle](#session-lifecycle)
  - [Programmatic Session Creation](#programmatic-session-creation)
  - [Hook Registration](#hook-registration)
- [MCP Server Integration](#mcp-server-integration)
  - [Server Configuration](#server-configuration)
  - [Tool Naming Convention](#tool-naming-convention)
  - [Server Protocol Flow](#server-protocol-flow)
- [Permission Bypass with Security](#permission-bypass-with-security)
  - [Security Model](#security-model)
  - [ActionGuard Rules](#actionguard-rules)
  - [Settings Configuration](#settings-configuration)
- [Vendor SDK Integration](#vendor-sdk-integration)
  - [OpenAI Agents SDK Integration](#openai-agents-sdk-integration)
  - [AutoGen SDK Integration](#autogen-sdk-integration)
...
---
*Source: [specs/017-claude-agent-sdk/spec.md](../../../specs/017-claude-agent-sdk/spec.md)*
