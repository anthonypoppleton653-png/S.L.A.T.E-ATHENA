...
<!-- Auto-generated from specs/015-vendor-integration/spec.md -->
<!-- Generated: 2026-02-09T09:07:02.947061+00:00 -->
...
- [Vendor 1: OpenAI Agents Python](#vendor-1-openai-agents-python)
  - [Overview](#overview)
  - [Problem Statement](#problem-statement)
  - [Solution: sys.path Swap](#solution-syspath-swap)
  - [Exported Types](#exported-types)
  - [Usage Pattern](#usage-pattern)
  - [Integration Points](#integration-points)
- [Vendor 2: Microsoft AutoGen](#vendor-2-microsoft-autogen)
  - [Overview](#overview)
  - [Vendor Path Structure](#vendor-path-structure)
  - [Version Mocking](#version-mocking)
  - [Exported Types](#exported-types)
  - [SLATE Agent Factory](#slate-agent-factory)
  - [Usage Pattern](#usage-pattern)
- [Vendor 3: Microsoft Semantic Kernel](#vendor-3-microsoft-semantic-kernel)
  - [Overview](#overview)
  - [Integration Module](#integration-module)
  - [Key Features](#key-features)
  - [Vendor Path](#vendor-path)
- [Vendor 4: GitHub Copilot SDK](#vendor-4-github-copilot-sdk)
  - [Overview](#overview)
  - [Integration Structure](#integration-structure)
  - [SLATE Tools Integration](#slate-tools-integration)
  - [Exported Types](#exported-types)
  - [Integration Files](#integration-files)
- [Vendor 5: Spec-Kit](#vendor-5-spec-kit)
  - [Overview](#overview)
  - [Integration Points](#integration-points)
  - [Spec Lifecycle](#spec-lifecycle)
  - [Features](#features)
- [Unified Integration Module](#unified-integration-module)
  - [vendor_integration.py](#vendor_integrationpy)
  - [API](#api)
  - [CLI Interface](#cli-interface)
  - [Status Output](#status-output)
- [Claude Agent SDK Integration](#claude-agent-sdk-integration)
  - [Integration Architecture](#integration-architecture)
  - [SLATE Agent Objects](#slate-agent-objects)
  - [ActionGuard Guardrail](#actionguard-guardrail)
- [Type Bridges](#type-bridges)
  - [Type Compatibility Matrix](#type-compatibility-matrix)
  - [Bridge Functions](#bridge-functions)
- [Vendor Submodule Management](#vendor-submodule-management)
  - [Git Submodules](#git-submodules)
  - [.gitmodules Configuration](#gitmodules-configuration)
  - [Fork Sync Commands](#fork-sync-commands)
- [Error Handling](#error-handling)
  - [SDK Unavailability](#sdk-unavailability)
  - [Error Logging](#error-logging)
- [Security Considerations](#security-considerations)
  - [Vendor Source Validation](#vendor-source-validation)
  - [ActionGuard Integration](#actionguard-integration)
- [Testing](#testing)
  - [Unit Tests](#unit-tests)
  - [Integration Tests](#integration-tests)
- [Implementation Files](#implementation-files)
- [Success Metrics](#success-metrics)
- [Integration Lock Declaration](#integration-lock-declaration)
...
---
*Source: [specs/015-vendor-integration/spec.md](../../../specs/015-vendor-integration/spec.md)*
