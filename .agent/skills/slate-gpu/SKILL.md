...
**Check GPU status:**
```powershell
.\.venv_slate_ag\Scripts\python.exe -c "from slate.mcp_server import slate_gpu; print(slate_gpu('status'))"
```

**Configure dual-GPU:**
```powershell
.\.venv_slate_ag\Scripts\python.exe -c "from slate.mcp_server import slate_gpu; print(slate_gpu('configure'))"
```

**Preload models:**
```powershell
.\.venv_slate_ag\Scripts\python.exe -c "from slate.mcp_server import slate_gpu; print(slate_gpu('preload'))"
```
