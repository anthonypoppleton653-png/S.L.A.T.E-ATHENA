...
```powershell
.\.venv_slate_ag\Scripts\python.exe -m slate/slate_runner_manager.py --setup
```

**Dispatch a workflow:**
```powershell
.\.venv_slate_ag\Scripts\python.exe -m slate/slate_runner_manager.py --dispatch "ci.yml"
```
