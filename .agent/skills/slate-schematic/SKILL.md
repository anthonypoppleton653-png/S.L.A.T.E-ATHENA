...
**From current system:**
```powershell
.\.venv_slate_ag\Scripts\python.exe -c "from slate.mcp_server import slate_schematic; print(slate_schematic('from-system'))"
```

**From tech tree:**
```powershell
.\.venv_slate_ag\Scripts\python.exe -c "from slate.mcp_server import slate_schematic; print(slate_schematic('from-tech-tree'))"
```

**List components:**
```powershell
.\.venv_slate_ag\Scripts\python.exe -c "from slate.mcp_server import slate_schematic; print(slate_schematic('components'))"
```
