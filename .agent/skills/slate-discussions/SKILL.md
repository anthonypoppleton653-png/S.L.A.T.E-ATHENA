...
```powershell
.\.venv_slate_ag\Scripts\python.exe -m slate/slate_discussion_manager.py --status
```

**List unanswered Q&A:**
```powershell
.\.venv_slate_ag\Scripts\python.exe -m slate/slate_discussion_manager.py --unanswered
```

**Sync to tasks:**
```powershell
.\.venv_slate_ag\Scripts\python.exe -m slate/slate_discussion_manager.py --sync-tasks
```
