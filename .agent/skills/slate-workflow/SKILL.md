...
```powershell
.\.venv_slate_ag\Scripts\python.exe -m slate/slate_workflow_manager.py --status
```

**For cleanup:**
```powershell
.\.venv_slate_ag\Scripts\python.exe -m slate/slate_workflow_manager.py --cleanup
```

**For enforcement check:**
```powershell
.\.venv_slate_ag\Scripts\python.exe -m slate/slate_workflow_manager.py --enforce
```
